    ...
    return(
        <div className="about-container">
           ...
           <div className="about-box2">
                    <p className="about-title">I am <span className="bold">Abdul-Haseeb-memon</span>, a passionate and detail-oriented Web Developer and AI enthusiast. My journey spans across various domains, including Web Development, Data Analytics, and UI/UX Design, with hands-on experience in technologies like Next.js, Tailwind CSS, and TypeScript.</p>
