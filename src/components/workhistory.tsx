             ...
             <div className="education-container2">
              ...
              <div className="education-box">
                ...
                <div className="left-box">
                    <h2 className="uni-name institue">Muet University</h2>
                ...
                <div className="right-box">
                    ...
                    <p className="uni-des ">In 2023, I enrolled in the University  to pursue a Bachelor&apos;s in Cyber, combining academic knowledge with practical skills.</p>
                </div>
              </div>
              <div className="education-box">
                {/* left */}
